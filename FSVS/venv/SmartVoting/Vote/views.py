...
def results(request):
    ...
    for c in pos:
        ...
        plt.axis('equal')
        name = "C:\\Users\\grohi\\PycharmProjects\\FSVS\\venv\\SmartVoting\\Vote\\static\\Vote\\" + c.position + '.png'
        fig.savefig(name)
        can[0].append(c)
        can[0].append(name)
        plt.close(fig)
...
def create_dataset(request):
    ...
    faceDetect = cv2.CascadeClassifier(r'C:\Users\grohi\PycharmProjects\FSVS\venv\SmartVoting\ml\haarcascade_frontalface_default.xml')
    ...
    while(True):
        ...
        for(x,y,w,h) in faces:
            ...
            cv2.imwrite(r'C:\Users\grohi\PycharmProjects\FSVS\venv\SmartVoting\ml\dataset\.'+str(id)+'.'+str(sampleNum)+'.jpg', gray[y:y+h,x:x+w])
...
def trainer(request):
    ...
    #Path of the samples
    path = r'C:\Users\grohi\PycharmProjects\FSVS\venv\SmartVoting\ml\dataset'
    ...
    recognizer.save(r'C:\Users\grohi\PycharmProjects\FSVS\venv\SmartVoting\ml\recognizer\trainingData.yml')
    cv2.destroyAllWindows()
...
def detect(request):
    ...
    rec.read(r'C:\Users\grohi\PycharmProjects\FSVS\venv\SmartVoting\ml\recognizer\trainingData.yml')
    getId = 0
